        ...
        <main className="min-h-screen pt-32 pb-20 mesh-gradient overflow-hidden">
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="max-w-2xl mx-auto text-2xl md:text-3xl text-slate-300 font-medium mb-8">
                        Passionate recruiters dedicated to connecting exceptional talent with the companies that need them most.
                    </p>
                    <p className="max-w-3xl mx-auto text-slate-200 italic text-2xl md:text-3xl leading-relaxed border-l-2 border-brand-blue/30 pl-6 py-2">
